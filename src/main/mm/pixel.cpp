...
namespace lsp
{
    namespace mm
    {
        ...
        static void convert_b4_to_pr8g8b8a8(uint8_t *dptr, const uint8_t *src, size_t count)
        {
            uint8_t v;
            uint32_t *dst   = reinterpret_cast<uint32_t *>(dptr);
            for (; count >= 2; count -= 2)
        ...
        static pixel_conversion_t pixel_convert_function_for_g4(pixel_format_t dst_fmt) noexcept
        {
            switch (dst_fmt)
            {
                ...
                case PIXFMT_PR8G8B8A8:
                    return convert_b4_to_pr8g8b8a8;
        ...
        static void convert_b8_to_pr8g8b8a8(uint8_t *dst, const uint8_t *src, size_t count)
        {
            uint8_t v;
            for (; count > 0; --count)
            {
        ...
        static pixel_conversion_t pixel_convert_function_for_g8(pixel_format_t dst_fmt) noexcept
        {
            switch (dst_fmt)
            {
                ...
                case PIXFMT_PR8G8B8A8:
                    return convert_b8_to_pr8g8b8a8;
        ...
        static void convert_r8g8b8a8_to_r8g8b8a8(uint8_t *dst, const uint8_t *src, size_t count)
        {
            for ( ; count > 0; --count)
            {
                dst[0]      = src[0];
        ...
        static pixel_conversion_t pixel_convert_function_for_r8g8b8a8(pixel_format_t dst_fmt) noexcept
        {
            switch (dst_fmt)
            {
                ...
                case PIXFMT_R8G8B8:
                    return convert_r8g8b8a8_to_r8g8b8a8;
                case PIXFMT_PR8G8B8A8:
